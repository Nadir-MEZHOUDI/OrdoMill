...
{
    private readonly SemaphoreSlim _refreshFacturesListSemaphore = new(1, 1);
    ...
    {
        await _refreshFacturesListSemaphore.WaitAsync();
        try
        {
        ...
        {
            _refreshFacturesListSemaphore.Release();
        }
    }
